...
# CSV 파일에 저장할 헤더
csv_header = ["code", "title", "aka", "summary", "rating",
            "release_date", "production_year", "production_condition ",
            "crank_in_up", "filming_count", "screen_type", "synopsis", "director",
            "actor", "producer", "distributor", "importer", "poster_url"]
    ...
    for i in range(200):
        ...
        if tr:  # 해당 id를 가진 <tr> 태그가 있으면
            ...
            if title_element:
                ...
                # 각 정보를 CSV 파일에 쓰기
                writer.writerow([code, title, aka, summary, rating, release_date, production_year, production_condition
                , crank_in_up, filming_count, screen_type, synopsis, director, actor, producer, distributor,
                importer, poster_url])
