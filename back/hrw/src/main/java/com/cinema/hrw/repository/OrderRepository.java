...
public interface OrderRepository extends JpaRepository<OrderEntity,String>{
    ...
    "FROM MovieEntity m " +
       "RIGHT JOIN OrderEntity o ON o.movieCode = m.code " +
       "LEFT JOIN ScheduleEntity s ON o.scheduleCode = s.scheduleCode " +
       "LEFT JOIN CinemaAddressEntity a ON s.cinemaCode = a.cinemaCode " +
